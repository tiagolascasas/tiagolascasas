        ...
        <div className="home-container fade-in">
            <div className="profile-section">
                <div className="img-container">
                    <img src={profileImg} alt="Tiago Lascasas" className="profile-img" />
                </div>

                <div className="profile-info">
                    <h1 className="name">Tiago Lascasas</h1>
                    <h2 className="title">PhD Student & Software Developer</h2>
                    ...
                    <div className="social-links">
                        ...
                        {/* Added Discord via Monitor icon as generic/gaming/server reference or just text if preferred, keeping icons consistent */}
                        <a href="#" className="social-item" aria-label="Discord">
                            <Monitor size={24} />
                            <span>Discord</span>
                        </a>
                    </div>
